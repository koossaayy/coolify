                    ...
                    <div class="mx-2">
                        @if (str($database->status)->contains('exited'))
                            <x-forms.select id="sslMode" label="SSL Mode" wire:model.live="sslMode"
                                ...
                                <option value="PREFERRED" title="Prefer secure connections">{{ __('Prefer (secure)') }}</option>
                                <option value="REQUIRED" title="Require secure connections">{{ __('Require (secure)') }}</option>
                                <option value="VERIFY_CA" title="Verify CA certificate">{{ __('Verify CA (secure)') }}</option>
                                <option value="VERIFY_IDENTITY" title="Verify full certificate">{{ __('Verify Full (secure)') }}
                                </option>
                            </x-forms.select>
                        @else
