    ...
    <form wire:submit="submit" class="flex flex-col gap-2">
        ...
        <div class="flex flex-col gap-2">
            @if ($database->started_at)
                <div class="pt-2 dark:text-warning">{{ __("If you change the values in the database, please sync it here, otherwise automations won't work.") }} <br>{{ __('Changing them here will not change the values in the database.') }}
                </div>
                <div class="flex gap-2">
