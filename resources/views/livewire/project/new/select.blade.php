<div x-data x-init="$wire.loadServers">
    ...
    <div class="pb-4">{{ __('Deploy resources, like Applications, Databases, Services...') }}</div>
    <div x-data="searchResources()">
        @if ($current_step === 'type')
            ...
            <div x-show="!loading" class="flex flex-col gap-4 py-4">
                ...
                <h4 x-show="filteredGitBasedApplications.length > 0">{{ __('Git Based') }}</h4>
                ...
                <h4 x-show="filteredDockerBasedApplications.length > 0">{{ __('Docker Based') }}</h4>
                ...
                <h2 x-show="filteredDatabases.length > 0">{{ __('Databases') }}</h2>
                ...
                <div x-show="filteredServices.length > 0">
                    ...
                    <div class="py-4 text-xs">{{ __('Trademarks Policy: The respective trademarks mentioned here are owned by the respective companies, and use of them does not imply any affiliation or endorsement.') }}<br>{{ __('Find more services') }}
                        <a class="dark:text-white underline" target="_blank"
                            href="https://coolify.io/docs/services/overview">{{ __('here') }}</a>.
                    </div>
            ...
            @else
                ...
                @empty
                    <div>
                        ...
                        <div>{{ __('No validated & reachable servers found.') }} <a class="underline dark:text-white" href="/servers">
                                {{ __('Go to servers page') }}
                            </a></div>
                    </div>
                @endforelse
