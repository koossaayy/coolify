<div class="flex flex-col gap-4">
    @if (
                                    ...
                                    <div x-show="volumeModalOpen" x-trap.inert.noscroll="volumeModalOpen"
                                        ...
                                        <div class="relative flex items-center justify-center w-auto"
                                            ...
                                            <form class="flex flex-col w-full gap-2 rounded-sm"
                                                ...
                                                @if ($isSwarm)
                                                    <div class="text-warning">{{ __('Swarm Mode detected: You need to set a shared volume (EFS/NFS/etc) on all the worker nodes if you would like to use a persistent volumes.') }}</div>
                                                @endif
        ...
        @if ($resource?->build_pack === 'dockercompose')
            <div class="dark:text-warning text-coollabs">{{ __('Please modify storage layout in your Docker Compose file or reload the compose file to reread the storage layout.') }}</div>
        @else
