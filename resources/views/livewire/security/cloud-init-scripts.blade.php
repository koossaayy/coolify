<div>
    ...
    <div class="pb-4 text-sm">{{ __('Manage reusable cloud-init scripts for server initialization. Currently working only with') }} <span class="text-red-500 font-bold">{{ __("Hetzner's") }}</span> {{ __('integration.') }}</div>
                ...
                <div class="flex justify-between items-center">
                    <div class="flex-1">
                        ...
                        <div class="text-xs text-neutral-500 dark:text-neutral-400">
                            {{ __('Created') }} {{ $script->created_at->diffForHumans() }}
                        </div>
                    </div>
                </div>
