                                    ...
                                    <div class="mb-4" x-init="selectedIndex = -1">
                                            ...
                                            <div>
                                                ...
                                                @if ($this->selectedResourceName)
                                                    <div class="text-xs text-neutral-500 dark:text-neutral-400">
                                                        {{ __('for') }} {{ $this->selectedResourceName }}
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        @else
                                            <div
                                                ...
                                                <p class="text-sm text-red-800 dark:text-red-200">{{ __('No servers available') }}</p>
                                            </div>
                                        @endif
                                    </div>
                                @endif
                                    ...
                                    <div class="mb-4" x-init="selectedIndex = -1">
                                        ...
                                        @if ($loadingDestinations)
                                            <div
                                                ...
                                                <span class="text-sm text-neutral-600 dark:text-neutral-400">{{ __('Loading destinations...') }}</span>
                                            </div>
                                                ...
                                                <button type="button"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="flex-1 min-w-0">
                                                            ...
                                                            <div
                                                                class="text-xs text-neutral-500 dark:text-neutral-400">
                                                                {{ __('Network:') }} {{ $destination['network'] }}
                                                            </div>
                                                        </div>
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                            class="shrink-0 h-5 w-5 text-yellow-500 dark:text-yellow-400"
                                        ...
                                        @else
                                            <div
                                                class="p-3 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-800">
                                                <p class="text-sm text-red-800 dark:text-red-200">{{ __('No destinations available') }}</p>
                                            </div>
                                        @endif
                                    </div>
                                @endif
                                ...
                                @if ($selectedDestinationUuid !== null && $selectedProjectUuid === null)
                                    <div class="mb-4" x-init="selectedIndex = -1">
                                        ...
                                        @else
                                            <div
                                                class="p-3 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-800">
                                                <p class="text-sm text-red-800 dark:text-red-200">{{ __('No projects available') }}</p>
                                            </div>
                                        @endif
                                    </div>
                                @endif
                                ...
                                @if ($selectedProjectUuid !== null && $selectedEnvironmentUuid === null)
                                    <div class="mb-4" x-init="selectedIndex = -1">
                                        ...
                                        @else
                                            <div
                                                class="p-3 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-800">
                                                <p class="text-sm text-red-800 dark:text-red-200">{{ __('No environments available') }}</p>
                                            </div>
                                        @endif
                                    </div>
                                @endif
