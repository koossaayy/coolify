                            ...
                            <div class="flex gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm dark:text-white text-black">
                                        {{ __('See how to set it in our') }} <a class="font-bold underline hover:text-coollabs"
                                            target="_blank" href="{{ config('constants.urls.docs') }}">{{ __('documentation') }}</a>{{ __(', or learn how to manually reset your password.') }}
                                    </p>
                                </div>
                            </div>
                        </div>
